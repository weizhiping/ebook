 ...
 * @author sylar
 */
public class MenuReadActivity extends Activity implements OnEnterListener {
	private static String TAG = "MenuReadActivity";
	...
	private void initViews() {
		...
		String[] menus = res.getStringArray(R.array.array_menu_read);
